...
class DoStudentExam extends Component {
  state = {
    exam: [],
    questions: [],
    selectedAnswers: {},
  ...
  componentDidMount() {
    ...
    this.getExam(this.props.match.params.id);
...
export default (
  connect(mapStateToProps, mapDispatchToProps)(DoStudentExam)
);
